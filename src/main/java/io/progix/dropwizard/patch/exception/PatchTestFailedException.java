 ...
 * <p/>
 * This exception is thrown automatically in the explicit patch method when the {@link ContextualTestOperation} returns false
 */
public class PatchTestFailedException extends RuntimeException {
    ...
    public PatchTestFailedException(JsonPath path, Object value) {
        super("A patch test operations failed. The value in '" + path
